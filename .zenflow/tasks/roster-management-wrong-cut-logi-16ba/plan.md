...
<!-- chat-id: 498069cd-34bb-4c16-9eac-0865b55b9f88 -->
...
4. Document findings in `{@artifacts_path}/investigation.md` (done):
   - Summary of the bug
   - Root cause analysis
   - Affected components
   - Impact assessment
...
<!-- chat-id: 4a000b69-241e-4141-a02e-aeeaa79b9985 -->
...
<!-- chat-id: e094bd11-b079-4461-a8f6-40fa6d2a80ee -->
